...
**Goal:** Remove backgrounds from Dr. Vivek Karpe's new photo, Dr. Ashwini Karpe's new photo, and Dr. Muniza Qureshi's existing photo to make them transparent, resize them all to `682x1024`, and output them as WebP.
...
5. Save the output to `assets/img/team/Dr-Vivek-Karpe.webp`, `assets/img/team/Dr-Ashwini-Karpe.webp`, and `assets/img/team/Dr-Muniza-Qureshi.webp`.
