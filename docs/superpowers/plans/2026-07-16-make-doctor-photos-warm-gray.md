...
**Goal:** Remove backgrounds from Dr. Vivek Karpe's new photo, Dr. Ashwini Karpe's new photo, and Dr. Muniza Qureshi's existing photo. Place them on a solid Warm Gray backdrop (`#EAE7E1`), and resize them to a uniform `682x1024` WebP without cropping their head/shoulder framing.
